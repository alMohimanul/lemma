...
def test_extract_paper_id_from_question():
    from MAVYN.llm.question_parser import extract_paper_ids
...
def test_wants_similar_papers():
    from MAVYN.llm.question_parser import wants_similar_papers
